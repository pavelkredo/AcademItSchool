...
public class Main {
    public static void main(String[] args) {
        double[][] array1 = {{1, 4, 7}, {4, 6, 2}, {12, 4, 2}};
        Matrix matrix1 = new Matrix(array1);
        double[][] array2 = {{5, 2, 1}, {5, 6, 1}, {3, 2, 7}};
        ...
        Vector vector1 = matrix3.getVectorString(0);
        System.out.println("Получение вектора-строки по индексу: " + vector1.toString());
        ...
        Vector vector2 = matrix3.getVectorMultiplication(vector1);
        System.out.println("Умножение матрицы на вектор: " + vector2.toString());
